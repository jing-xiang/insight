          ...
          <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f2f5] px-10 py-3">
            ...
            <div className="flex flex-1 justify-end gap-8">
              <div className="flex items-center gap-9">
                ...
                <a className="text-[#111418] text-sm font-medium leading-normal" href="https://www.citigroup.com/global/insights/research">Research</a>
                <a className="text-[#111418] text-sm font-medium leading-normal" href="https://www1.citibank.com.sg/wealth-management/investments/portfolio-finance">Portfolio</a>
                <a className="text-[#111418] text-sm font-medium leading-normal" href="https://finance.yahoo.com/">News</a>
              </div>
              <a
